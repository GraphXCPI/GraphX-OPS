...
const currentOpsPageMap = {
  ...
  "Store Personalization:Language Text References": "035-language_constant_action",
  "Designer Studio:Studio Settings:Language Text References": "102-studio_language_constant_action",
  "Language Text References": "035-language_constant_action",
  "Store Personalization:Promotional Message": "064-promotional_listing",
  "Promotional Message": "064-promotional_listing",
  "Store Personalization:Sidebar Management:Sidebar Management": "095-sidebar_management",
  "Store Personalization:Sidebar Management:Sidebar Widget": "096-sidebar_widget",
  "Sidebar Management": "095-sidebar_management",
  "Sidebar Widget": "096-sidebar_widget",
  "HTML Help": "027-htmlhelp",
  "htmlhelp.php": "027-htmlhelp",
  "Add-on / Buy Plugin": "001-addon_buy_plugin",
  "addon_buy_plugin.php": "001-addon_buy_plugin",
  "Job Board Grid": "033-job_board_order_grid",
  "job_board_order_grid.php": "033-job_board_order_grid",
  "Job Board Order": "034-job_board_order",
  "job_board_order.php": "034-job_board_order",
...
function revisedPage() {
  ...
  if (view === "reports") return genericRevised("Reports & System Logs", ["Sales Reports", "Production Reports", "Inventory Reports", "System Logs"], ["084-report_sales_order_summary", "079-report_production_day_summary", "078-report_product_stock_summary", "068-report_audit_log"]);
  if (view === "admin") return genericRevised("Admin Users", ["Users", "Roles"], ["004-admin_listing", "003-admin_group"]);
  if (view === "customers") return genericRevised("Customer Accounts", ["Customers", "B2B Account Users", "Store Admins", "User Groups", "Access & Permissions", "Newsletter", "Design Proofs"], ["114-user_listing", "114-user_listing", "114-user_listing", "114-user_listing", "114-user_listing", "103-subscriber_listing", "019-design_proofs_listing"]);
