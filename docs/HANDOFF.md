...
- Current OPS generated-route smoke on 2026-07-06:
  ...
  - `#current/print-products` and `#current/ready-products` now use committed local copies of the public staging `/images/product/` assets referenced by their captured product-listing HTML, including visible thumbnails and fancybox `data-src` targets; the `/images/orders/` privacy guard remains unchanged.
