...
- Final generated bundle status from the latest 2026-07-06 full-source/CDP merge:
  ...
  - targeted product/settings and template/email gap queues were added at `docs/targeted-product-settings-gap-capture-queue-2026-07-06.csv` and `docs/targeted-template-email-gap-capture-queue-2026-07-06.csv`;
...
- Product/settings/template linked-route scan on 2026-07-06:
  - `ops-extracted-pages.js` generated `353` extracted OPS pages after merging the targeted live capture roots;
